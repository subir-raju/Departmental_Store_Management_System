...
public class DataSourceModifyEmployee extends DataSourceEmployee{
    ...
    // constructor;
    public DataSourceModifyEmployee() {
        super(DataSourceModifyEmployee.JD_DB_CONNECTION);
    }


    // method for searching the goods by name
    public boolean updateEmployee(String oldVal,String newVal,String colName){
        ...
        try{
            ...
            statement.execute("UPDATE "+TABLE_EMPLOYEE+" SET "+colName+"="+newValeBuild+" WHERE "+colName+"="+oldBuild);
    ...
    public boolean deleteRecord(String val){
        ...
        try{
            ...
            statement.execute("DELETE FROM "+TABLE_EMPLOYEE+" WHERE "+COL_NAME+"="+newValeBuild);
